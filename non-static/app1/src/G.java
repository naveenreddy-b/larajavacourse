...
//while you are refering to the class case must be same(as a standard we will write class name in camel case like ThisIsTheCamelCase
//objects are stored inside heap memory
//non-static members are loading to the memory while objects are created 
//all non-static members are loading to the memory while we are creating  that particular class.it can be non-variable or can be non-static method it can be